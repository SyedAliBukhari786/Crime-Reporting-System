import 'package:crimereportingsystem/registration.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 5.0),
              Text("Login to your account",style: TextStyle(fontSize: 18.0),),
               ...
               // crossAxisAlignment: CrossAxisAlignment.center,
                ...
                children: [
                 CustomElevatedbutton(context: context, height: 45, width: 0.14, label: "Login", route: Dashboard(), Buttoncolor: Colors.green[600]!, Textcolor: Colors.white, radius: 8.0,cat:1,EmailController: emailcontroller,PasswordController: passwordcontroller,email: eemail,password: ppassword),
                  SizedBox(width: 20,),
                  CustomElevatedbutton(context: context, height: 45, width: 0.14, label: "Register", route: Registration(), Buttoncolor: Colors.white, Textcolor: Colors.black
                      , radius: 8.0, cat:2,EmailController: emailcontroller,PasswordController: passwordcontroller,email: eemail,password: ppassword),
                ],
              ),
